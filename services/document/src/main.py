...
from core.config import DOCUMENT_GRPC_ADDRESS, GENERATED_DIR, ensure_directories
from db.connection import database_connection
from services.application import document_application
...
from api.routes.ai_invoice import router as ai_invoice_router
